    ...
    <div className="flex items-center gap-2 flex-shrink-0">
      ...
      >
        ...
        >
            ...
            className="
                outline-none text-sm w-56 md:w-64 bg-transparent
      ...
      <div className="bg-white rounded-lg shadow overflow-x-auto">
        <table className="min-w-full table-fixed" ref={tableRef}>
          <colgroup>
            ...
            <col className="w-36" />
            <col className="w-28" />
            <col className="w-[420px]" /> {/* supplier column - wide */}
            <col className="hidden lg:table-cell w-56" />
            <col className="hidden xl:table-cell w-40" />
            <col className="hidden xl:table-cell w-40" />
            <col className="w-32" />
            <col className="hidden lg:table-cell w-32" />
            <col className="w-28" />
          </colgroup>
